export module fstd.core.unicode;
...
namespace fstd
{
	namespace core
	{
		export typedef uint32_t Code_Point;
		...
		export inline Code_Point from_utf8(uint8_t code_unit_1, uint8_t code_unit_2, uint8_t code_unit_3, uint8_t code_unit_4, size_t& peek)
		{
		...
		export inline size_t to_utf8(Code_Point code_point, uint8_t* buffer)
		{
		...
		export inline Code_Point from_utf16LE(uint16_t code_unit_1, uint16_t code_unit_2, size_t& peek)
		{
		...
		// The function return the number of code units written.
		export inline size_t to_utf16LE(Code_Point code_point, uint16_t* buffer)
		{
		...
		export inline void from_utf8_to_utf16LE(const language::string_view& utf8_string, language::UTF16LE_string& utf16LE_string, bool null_terminated)
		{
		...
		export inline void from_utf8_to_utf16LE(const language::string& utf8_string, language::UTF16LE_string& utf16LE_string, bool null_terminated)
		{
		...
		// The '\0' doesn't count in the string size, but the string buffer is reserved according to.
		export inline void from_utf16LE_to_utf8(const language::UTF16LE_string_view& utf16LE_string, language::string& utf8_string, bool null_terminated)
		{
			size_t	code_unit_index = 0;
			size_t	result_size = 0;
		...
		export inline void from_utf16LE_to_utf8(const language::UTF16LE_string& utf16LE_string, language::string& utf8_string, bool null_terminated)
		{
