export module fstd.system.allocator;
...
namespace fstd
{
	namespace system
	{
		export void	allocator_initialize();
		export void*	allocate(size_t size);
		export void*	reallocate(void* address, size_t size);
		export void	free(void* address);

		export void	memory_copy(void* destination, const void* source, size_t size);
		export void	memory_move(void* destination, const void* source, size_t size);
		export void	fill_memory(void* destination, size_t size, uint8_t value);
		export void	zero_memory(void* destination, size_t size);

		export inline bool memory_compare(const void* a, const void* b, size_t size)
		{
			// @TODO @SpeedUp
