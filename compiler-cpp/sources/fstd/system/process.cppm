export module fstd.system.process;
...
namespace fstd
{
	namespace system
	{
		export void exit_process(int exit_code);
		export bool execute_process(const system::Path& executable_path, const language::string& arguments);
	}
}
