...
namespace f
{
    ...
    export void			parse(fstd::memory::Array<Token>& tokens, AST& ast);
	export inline bool	is_binary_operator(const AST_Node* node);
	export void			generate_dot_file(AST& ast, const fstd::system::Path& output_file_path);
