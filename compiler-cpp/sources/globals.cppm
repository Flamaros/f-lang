...
export void initialize_globals();
...
export void report_error(Compiler_Error error, const f::Token& token, const char* error_message);
export void abort_compilation();
